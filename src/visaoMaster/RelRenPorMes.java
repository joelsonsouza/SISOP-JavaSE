 ...
 * @author Professor
 */
public class RelRenPorMes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Renda por Mês");
        setResizable(false);
    ...
    private void jButtonImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonImprimirMouseClicked
        Rel relat = new Rel();
        relat.RelRenPorMes((String) jComboBoxAno.getSelectedItem(), (String) jComboBoxMes.getSelectedItem());
