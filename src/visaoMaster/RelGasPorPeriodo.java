 ...
 * @author Professor
 */
public class RelGasPorPeriodo extends javax.swing.JFrame {
    ConexaoBD conex = new ConexaoBD();
    /**
     * Creates new form janelaPadrao
     */
    public RelGasPorPeriodo() {
        initComponents();
        CbAno();
        CbMes();
        //CbPeriodo();
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Gastos por Mês");
        setResizable(false);
        ...
        jComboBoxMes.setBounds(60, 90, 120, 30);
        ...
        jLabelPeriodo.setBounds(-10, 130, 70, 30);

        jComboBoxPeriodo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jComboBoxPeriodo.setBounds(60, 130, 120, 30);
    ...
    private void jButtonImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonImprimirMouseClicked
        Rel relat = new Rel();
        relat.RelGasPorPeriodo((String) jComboBoxAno.getSelectedItem(), (String) jComboBoxMes.getSelectedItem(), (String) jComboBoxPeriodo.getSelectedItem() );
    ...
    public void CbMes(){
        ...
        conex.conexao();
        conex.executaSql("select DISTINCT mes  from tbl_regmov");
        try{
            conex.rs.first();
    ...
    public void CbPeriodo(){
    
        conex.conexao();
        conex.executaSql("select DISTINCT periodo from tbl_roots");
        try{
            conex.rs.first();
            jComboBoxPeriodo.removeAllItems();
            do{
                jComboBoxPeriodo.addItem(conex.rs.getString("periodo").toUpperCase());
            }while(conex.rs.next());
