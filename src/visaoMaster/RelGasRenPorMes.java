 ...
 * @author Professor
 */
public class RelGasRenPorMes extends javax.swing.JFrame {
    ConexaoBD conex = new ConexaoBD();
    /**
     * Creates new form janelaPadrao
     */
    public RelGasRenPorMes() {
        initComponents();
        CbAno();
        CbMes();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Gastos e Rendas por Mês");
        setResizable(false);
    ...
    private void jButtonImprimirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonImprimirMouseClicked
        Rel relat = new Rel();
        relat.RelGasRenPorMes((String) jComboBoxAno.getSelectedItem(), (String) jComboBoxMes.getSelectedItem());
