 ...
 * @author Professor
 */
public class RelAplPorAno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Relatório Investimentos por Ano");
        setAlwaysOnTop(true);
        setResizable(false);
        ...
        jLabelAno.setBounds(70, 90, 50, 30);
        ...
        jComboBoxAno.setBounds(130, 90, 120, 30);
    ...
    private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
       Rel relat = new Rel();
       relat.RelAplPorAno((String) jComboBoxAno.getSelectedItem());
       
//método sem paramêtro
       /*String ano = (String) jComboBoxAno.getSelectedItem();
             
        
                try{
                    conex.executaSql("SELECT a.ano, a.mes, b.periodo, b.descricaotipo, a.detalhamento, a.valor FROM tbl_regmov as a inner join tbl_roots as b on (a.id_tipo = b.id_tipo) WHERE a.tipo = 'GASTO' and a.ano = '"+ano+"'");
                    ...
                    JasperPrint jpPrint = JasperFillManager.fillReport("iReport/MovFinanceirasPorAno.jasper", new HashMap(), relatResul);// HashMap:Mapeamento do Diretório// relatResul: passa a base de dados que o rel sera preenchido
